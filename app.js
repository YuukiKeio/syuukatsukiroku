...
/* ---- 業界の自動分類（ルールベース） ---- */
/* 上から順に評価。具体的な企業名を汎用キーワードより先に置き、誤判定(例:ソフトバンク→銀行)を防ぐ */
const INDUSTRY_RULES = [
  // == 具体的な有名企業(優先) ==
  [/ソフトバンク|KDDI|ドコモ|楽天モバイル|NTT(?!データ)|au\b/, 'IT・通信', '通信キャリア'],
  [/NTTデータ|野村総研|NRI|SCSK|TIS|BIPROGY|日本総研|伊藤忠テクノ/, 'IT・通信', 'SIer・システム開発'],
  [/任天堂|バンダイ|ナムコ|スクウェア|スクエニ|カプコン|コーエー|セガ|コナミ|サイゲーム|グリー|ミクシィ|mixi/, 'IT・通信', 'ゲーム・エンタメ'],
  [/リクルート|パーソル|マイナビ|エン・?ジャパン|ビズリーチ|ディップ|パソナ|ベネッセ|学研|ヒューリック/, 'サービス・人材', '人材・教育'],
  [/キーエンス|ファナック|村田製作所|日本電産|ニデック|オムロン|SMC|ローム|TDK|京セラ|安川電機/, 'メーカー', '電機・精密・機械'],
  [/ファーストリテイリング|ユニクロ|GU\b|しまむら|アダストリア|オンワード|ワールド|ZOZO/, '小売・流通', 'アパレル・専門店'],
  [/資生堂|花王|コーセー|ライオン|ユニ・?チャーム|P&G|ロレアル|マンダム|ファンケル/, 'メーカー', '化粧品・日用品'],
  [/明治|森永|グリコ|カルビー|日清|キユーピー|味の素|ハウス食品|日本ハム|山崎製パン|ヤクルト/, 'メーカー', '食品'],
  [/サントリー|キリン|アサヒ|サッポロ|伊藤園|コカ・?コーラ|ダイドー/, 'メーカー', '食品・飲料'],
  [/武田薬品|アステラス|第一三共|エーザイ|中外製薬|大塚製薬|塩野義|田辺三菱|小野薬品|大日本住友/, 'メーカー', '医薬品'],
  [/講談社|集英社|小学館|KADOKAWA|角川|文藝春秋|新潮社|東洋経済|日経BP/, 'マスコミ・広告', '出版'],
  [/電通|博報堂|ADK|サイバーエージェント|セプテーニ|オプト/, 'マスコミ・広告', '広告・Web'],
  [/フジテレビ|日本テレビ|TBS|テレビ朝日|テレビ東京|NHK|WOWOW/, 'マスコミ・広告', '放送'],
  [/読売新聞|朝日新聞|日経|日本経済新聞|毎日新聞|産経|時事通信|共同通信/, 'マスコミ・広告', '新聞'],
  [/トヨタ|ホンダ|日産|マツダ|スバル|SUBARU|スズキ|ダイハツ|いすゞ|デンソー|アイシン|ブリヂストン/, 'メーカー', '自動車・部品'],
  [/三菱重工|川崎重工|IHI|クボタ|コマツ|小松製作所|ダイキン|日立建機/, 'メーカー', '機械・重工'],
  [/新日鉄|日本製鉄|JFE|神戸製鋼|住友金属|三菱マテリアル|UACJ|住友電工/, 'メーカー', '鉄鋼・非鉄・金属'],
  [/三菱ケミカル|住友化学|三井化学|信越化学|旭化成|東レ|帝人|クラレ|花王ケミカル|富士フイルム/, 'メーカー', '化学・素材'],
  [/積水ハウス|大和ハウス|住友林業|大東建託|一条工務店|飯田グループ/, '建設・不動産', 'ハウスメーカー'],
  [/鹿島|大成建設|清水建設|大林組|竹中工務店|前田建設|戸田建設/, '建設・不動産', 'ゼネコン'],
  [/三井不動産|三菱地所|住友不動産|東急不動産|野村不動産|森ビル|ヒューリック/, '建設・不動産', 'デベロッパー'],
  [/JR|東日本旅客|東海旅客|西日本旅客|東急|近鉄|阪急|小田急|京王|名鉄|西武鉄道/, '運輸・物流', '鉄道'],
  [/ANA|JAL|全日空|日本航空|スカイマーク|ソラシド/, '運輸・物流', '航空'],
  [/日本郵船|商船三井|川崎汽船|ヤマト運輸|佐川|日本通運|日通|SGホールディングス|センコー/, '運輸・物流', '海運・物流'],
  [/東京電力|関西電力|中部電力|九州電力|東北電力|中国電力|北海道電力|電源開発|Jパワー/, 'インフラ', '電力'],
  [/東京ガス|大阪ガス|東邦ガス|ENEOS|出光|コスモ石油|INPEX/, 'インフラ', 'ガス・石油'],
  [/三越|伊勢丹|高島屋|大丸|松坂屋|そごう|阪急百貨店/, '小売・流通', '百貨店'],
  [/イオン|セブン&アイ|セブンイレブン|ローソン|ファミリーマート|ニトリ|良品計画|無印/, '小売・流通', '小売・チェーン'],
  // == 汎用キーワード(フォールバック) ==
  [/総合商社|商事|物産|丸紅|双日|豊田通商|専門商社/, '商社・卸売', '商社'],
  [/信託銀行|銀行|みずほ|三菱UFJ|三井住友|りそな|信用金庫|信金/, '金融', '銀行'],
  [/証券|野村|大和|SMBC日興|マネックス/, '金融', '証券'],
  [/生命|生保|損保|損害保険|海上|あいおい|東京海上|SOMPO/, '金融', '保険'],
  [/リース|クレジット|カード|信販|JCB|オリコ|アイフル|投資/, '金融', 'その他金融'],
  [/コンサル|PwC|デロイト|KPMG|EY|アクセンチュア|ベイン|マッキンゼー|BCG|アビーム|ローランド/, 'コンサルティング', 'コンサル'],
  [/ソフト|システム|テクノロジ|デジタル|サイバー|IT|DeNA|LINE|ヤフー|富士通|NEC|SAP|IBM|グーグル|Google|アマゾン|Amazon|楽天|メルカリ|サイボウズ|freee|マネーフォワード|ラクス/, 'IT・通信', 'Web・ITサービス'],
  [/自動車|モーター|車両/, 'メーカー', '自動車'],
  [/電機|電気|エレクトロ|パナソニック|ソニー|日立|東芝|三菱電機|シャープ|半導体/, 'メーカー', '電機・精密'],
  [/化学|素材|化成|マテリアル|繊維|ガラス|セラミック/, 'メーカー', '化学・素材'],
  [/製薬|薬品|ファーマ|バイオ|医薬/, 'メーカー', '医薬品'],
  [/食品|飲料|製菓|製パン|乳業|ビール|酒造/, 'メーカー', '食品'],
  [/化粧品|コスメ|トイレタリー|日用品/, 'メーカー', '化粧品・日用品'],
  [/広告|メディア|マーケティング/, 'マスコミ・広告', '広告・メディア'],
  [/出版|新聞|放送|テレビ|印刷/, 'マスコミ・広告', 'マスコミ'],
  [/不動産|地所|デベロッパー/, '建設・不動産', '不動産'],
  [/ハウス|住宅|工務店/, '建設・不動産', 'ハウスメーカー'],
  [/建設|建築|ゼネコン|組\b|土木|設備/, '建設・不動産', '建設'],
  [/鉄道|旅客|電鉄/, '運輸・物流', '鉄道'],
  [/航空|エアライン/, '運輸・物流', '航空'],
  [/海運|汽船|運輸|物流|運送|ロジ|倉庫/, '運輸・物流', '物流'],
  [/電力|ガス|石油|エネルギー|インフラ/, 'インフラ', 'エネルギー'],
  [/百貨店|スーパー|コンビニ|小売|流通|ストア|EC|通販/, '小売・流通', '小売'],
  [/人材|派遣|教育|学習|保育|介護/, 'サービス・人材', '人材・サービス'],
  [/銀行|バンク/, '金融', '銀行'],
  [/商社/, '商社・卸売', '商社'],
];
function classifyIndustry(name) {
  const s = (name || '').trim();
  if (!s) return null;
  const hit = INDUSTRY_RULES.find(([re]) => re.test(s));
  return hit ? { industry: hit[1], subIndustry: hit[2] } : null;
}
...
function openProfileEditor(cid) {
  ...
  const q = s => w.querySelector(s);
  q('[data-classify]').onclick = () => {
    const r = classifyIndustry(q('#p_name').value + ' ' + q('#p_official').value);
    if (r) {
      q('#p_industry').value = r.industry; q('#p_sub').value = r.subIndustry;
      q('#p_clsview').textContent = `${r.industry} › ${r.subIndustry}`;
      q('#p_clsnote').textContent = '企業名から分類候補を更新しました。内容を確認して修正できます。';
    } else {
      // 自動判定できないときは既存入力を上書きしない
      q('#p_clsnote').textContent = '自動判定できませんでした。業界・細分業界を手動で入力してください。';
    }
  };
  w.querySelectorAll('[data-x]').forEach(b => b.onclick = () => w.remove());
  q('[data-del]').onclick = () => {
